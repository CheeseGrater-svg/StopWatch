...
<a href="../"><h1 class="text-5xl font-black leading-none mt-6">StopWatch</h1></a>
...
<div class="mt-4 relative">
  <img src={soyjacks} alt="two soyjacks pointing svelte" class="relative w-56 rounded-xl z-10">
  <div class="absolute inset-0 z-0 bg-gradient-to-r from-cyan-500 to-fuchsia-500 rounded-3xl blur-xl opacity-50"></div>
</div>
